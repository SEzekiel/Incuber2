function login() {
	...
	request.open("GET","http://incuber.spleint.com/functions.php?username="+username+"&password="+password, true);
	request.send();
}
...
function signup() {
	...
	request.open("GET","http://incuber.spleint.com/functions.php?username="+username+"&password="+password+"&name="+name, true);
	request.send();
}
...
document.getElementById('phone').value = "";
	...
	request.open("GET","http://incuber.spleint.com/functions.php?uname="+name+"&phone="+phone+"&mname="+name1+"&tyme="+tyme, true);
	request.send();
}
}
...
function fetch() {
	...
	request.open("GET","http://incuber.spleint.com/functions.php?i=fetch", true);
	request.send();
